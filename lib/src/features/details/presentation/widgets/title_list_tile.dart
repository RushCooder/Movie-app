    ...
    Future.delayed(
      ...
      () {
        context.read<StatusBloc>().add(
              FindMovieFromBookmarkStatusEvent(movieId: movie.id!),
            );
      },
    );
    ...
    return ListTile(
      ...
      trailing: IconButton(
        onPressed: () {
          ...
          // context.read<StatusBloc>().add(
          //       FindMovieFromBookmarkStatusEvent(
          //         movieId: movieBookmark.id!,
          //       ),
          //     );
        },
        icon: BlocBuilder<StatusBloc, StatusState>(
          builder: (context, state) {
            print("status state: $state");
            if (state is FindMovieFromBookmarkStatusState &&
